...
The Leaderboard, running as an online platform, presents users as well as their individual scores, with the highest ranking user displayed at the top.
...
- [Live Demo Link](https://mryeminthu.github.io/Leaderboard/dist)
...
Feel free to check the [issues page](https://github.com/mryeminthu/Leaderboard/issues).
